...
class PatternGenerator
    : public IRGeneratorBase,
      public PatternVisitor<PatternGenerator, void, mlir::Value> {
public:
  PatternGenerator(IRGen &irGen, mlir::OpBuilder &builder)
...
void PatternGenerator::visitVarPattern(VarPattern *pattern, mlir::Value value) {
  ...
  irGen.genVarDecl(builder, pattern->getVarDecl(), value);
}
...
void PatternGenerator::visitTuplePattern(TuplePattern *pattern,
  ...
  ir::DestructureTupleOp destructuredTuple =
      builder.create<ir::DestructureTupleOp>(getNodeLoc(pattern), value);
...
void IRGen::genPattern(mlir::OpBuilder &builder, Pattern *pattern,
                       mlir::Value value) {
